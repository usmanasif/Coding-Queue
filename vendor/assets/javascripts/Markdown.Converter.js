...
(function () {
    ...
    Markdown.Converter = function () {
        ...
        function _HashHTMLBlocks(text) {
            ...
            /*
             text = text.replace(/
             DoCodeBlocks                    ^                   // start of line  (with /m)
        ...
        function _DoCodeBlocks(text) {
            ...
            text = text.replace(/(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=~0))/g,
                function (wholeMatch, m1, m2) {
                    ...
                    //codeblock = "<pre class=&#39;highlight&#32;prettyprint&#32;lang-null&#32;linenums&#32;theme-balupton&#32;prettyprint-has&#39;><code>" + codeblock + "\n</code></pre>";
                    //codeblock = "<pre class=highlight&#32;prettyprint&#32;lang-null&#32;linenums&#32;theme-balupton&#32;prettyprint-has><code>" + codeblock + "\n</code></pre>";

                    return "\n\n" + "<pre class=prettyprint linenums>" + codeblock + "</pre>" + "\n\n" + nextChar;
        ...
        function _DoCodeSpans(text) {
            ...
            text = text.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm,
                function (wholeMatch, m1, m2, m3, m4) {
                    ...
                    //return m1 + "<code class=&#39;prettyprint linenums&#39;>" + c + "</code>";
                    return m1 + "<code class=&#39;prettyprint&#32;linenums&#39;>" + c + "</code>";
                    //return m1 + "<code class=&#39;highlight&#32;prettyprint&#32;lang-null&#32;linenums&#32;theme-balupton&#32;prettyprint-has&#39;>" + c + "</code>";
                    //return m1 + "<code class=&#39;highlight&#32;prettyprint&#32;lang-null&#32;linenums&#32;theme-balupton&#32;prettyprint-has>" + c + "</code>";
                }
            );
